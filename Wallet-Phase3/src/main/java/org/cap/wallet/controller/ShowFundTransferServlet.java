...
/**
 * Servlet implementation class ShowFundTransferServlet
 */
@WebServlet("/ShowFundTransferServlet")
public class ShowFundTransferServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Account> allAccounts = accService.printAccounts(user.getUserId());
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"      <input type=\"text\" class=\"form-control\" id=\"description\" placeholder=\"Enter description for transaction\" name=\"description\">\r\n" + 
				"    </div>\r\n" + 
				"    <div class=\"form-group\">\r\n" + 
				"      <label for=\"balance\">TransferAmount:</label>\r\n" + 
				"      <input type=\"number\" min = \"0\" class=\"form-control\" id=\"balance\" placeholder=\"Enter withdraw amount\" name=\"balance\">\r\n" + 
				"    </div>\r\n" + 
				"     <div class=\"form-group\">\r\n" + 
				"      <label for=\"account\">Enter From Account Id:</label>\r\n");
		out.println("<select name =\"fromaccount\">");
			...
			out.println("</select>");
				...
				out.println(				"     <div class=\"form-group\">\r\n" + 
						"      <label for=\"account\">Enter To Account Id:</label>\r\n");
