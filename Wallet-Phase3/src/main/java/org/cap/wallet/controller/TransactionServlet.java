...
public class TransactionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Account chosenAccount = accService.getAccount(id);
		List<Transaction> transactions = accService.getTransactionsFromDate(fromDate, endDate, chosenAccount);
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"    <tr>\r\n");
					for (Transaction trans: transactions) {
						out.println("<tr>");
						out.println("<td>" + trans.getTransactionDate() + "</td>" + "<td>" + trans.getTransactionamount() + "</td>" + "<td>" + trans.getTransactionDescription() + "</td>" + "<td>" + trans.getTransactionType() + "</td>" + "<td>" + trans.getFromAccount().getAccountId() + "</td>" + "<td>" + trans.getToAccount().getAccountId() + "</td>");
						out.println("</tr>");
					}
				out.println(
				"    </table>" +
